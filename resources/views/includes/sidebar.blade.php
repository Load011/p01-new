...
<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item @if(request()->routeIs('host.index') || request()->routeIs('asset.index') || request()->routeIs('wilayah.index')) menu-open @endif">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ route('wilayah.index') }}" class="nav-link @if(request()->routeIs('wilayah.index')) active @endif">
